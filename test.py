...
def Combat():
  print(Name,"est au Combat")
  print("1 : ATTAQUE")
  print("2 : INVENTAIRE")
  print("3 : FUITE")
  option = int(input("FAIT TON CHOIX"))

  if option == 1 :
    print(Name, "à choisi d'attaquer !")
    ATTAQUE()
  if option == 2 :
    print(Name, "à choisi l'inventaire !")
    Item()
  if option == 3 :
    print(Name, "FUIT LE COMBAT")

  return option


def ATTAQUE():
  print(Name, "Choisi son attaque")
...
def Fuire():
  print(Name,"essaye de prendre la fuite")


  d = randint(1,2)
  print(d)
  if d == 1 :
    print(Name, "n'a pas réussie à fuire")
    Combat()
  if d == 2 :
    print(Name,"à réussie à fuire")
    print(Name, "choisi ta direction")
    Maps()
